# Source Map Toolkit [![Build status](https://ci.appveyor.com/api/projects/status/e6crgc02lq65bjeg?svg=true)](https://ci.appveyor.com/project/thomabr/sourcemap-toolkit-3tfu6)
