using SourcemapToolkit.CallstackDeminifier.Utilities;
...
internal class SourceMapStore : ISourceMapStore
{
	...
	public SourceMapStore(ISourceMapProvider sourceMapProvider, bool removeSourcesContent)
	{
		...
		_sourceMapParser = new(removeSourcesContent);
		_sourceMapCache = new(sourceCodeUrl => _sourceMapParser.ParseSourceMap(_sourceMapProvider.GetSourceMapContentsForCallstackUrl(sourceCodeUrl)));
	}
