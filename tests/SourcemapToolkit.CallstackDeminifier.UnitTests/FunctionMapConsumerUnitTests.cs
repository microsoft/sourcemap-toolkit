	...
	public class FunctionMapConsumerUnitTests
	{
		...
		public void GetWrappingFunctionForSourceLocation_SingleIrrelevantFunctionMapEntry_ReturnNull()
		{
			...
			var functionMap = new List<FunctionMapEntry>
			{
				new FunctionMapEntry(
					...
					startSourcePosition: new SourcePosition(line: 40, column: 10),
					endSourcePosition: new SourcePosition(line: 50, column: 10))
		...
		public void GetWrappingFunctionForSourceLocation_MultipleFunctionMapEntriesSingleRelevantFunctionMapEntry_ReturnWrappingFunction()
		{
			...
			var functionMapEntry = new FunctionMapEntry(
				bindings: default(IReadOnlyList<BindingInformation>),
				deminifiedMethodName: default(string),
				startSourcePosition: new SourcePosition(line: 10, column: 10),
				endSourcePosition: new SourcePosition(line: 20, column: 30));
			var functionMapEntry2 = new FunctionMapEntry(
				bindings: default(IReadOnlyList<BindingInformation>),
				deminifiedMethodName: default(string),
				startSourcePosition: new SourcePosition(line: 30, column: 0),
				endSourcePosition: new SourcePosition(line: 40, column: 2));
			var functionMap = new List<FunctionMapEntry>
			{
				functionMapEntry,
				functionMapEntry2,
		...
		public void GetWrappingFunctionForSourceLocation_MultipleFunctionMapEntriesMultipleRelevantFunctionMapEntry_ReturnClosestWrappingFunction()
		{
			...
			var functionMapEntry = new FunctionMapEntry(
				bindings: default(IReadOnlyList<BindingInformation>),
				deminifiedMethodName: default(string),
				startSourcePosition: new SourcePosition(line: 5, column: 10),
				endSourcePosition: new SourcePosition(line: 20, column: 30));
			var functionMapEntry2 = new FunctionMapEntry(
				bindings: default(IReadOnlyList<BindingInformation>),
				deminifiedMethodName: default(string),
				startSourcePosition: new SourcePosition(line: 9, column: 0),
				endSourcePosition: new SourcePosition(line: 15, column: 2));
			var functionMap = new List<FunctionMapEntry>
			{
				functionMapEntry2,
				functionMapEntry
