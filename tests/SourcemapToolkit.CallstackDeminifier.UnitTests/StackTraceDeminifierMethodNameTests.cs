...
public class StackTraceDeminifierMethodNameTests
{
	...
	private static void ValidateDeminifyStackTraceResults(DeminifyStackTraceResult results)
	{
		...
		Assert.Equal(16, results.DeminifiedStackFrameResults[0].StackFrame.SourcePosition.Line);
		Assert.Equal("level3", results.DeminifiedStackFrameResults[1].StackFrame.MethodName);
		Assert.Equal("level2", results.DeminifiedStackFrameResults[2].StackFrame.MethodName);
		Assert.Equal("level1", results.DeminifiedStackFrameResults[3].StackFrame.MethodName);
		Assert.Equal("causeCrash", results.DeminifiedStackFrameResults[4].StackFrame.MethodName);
		Assert.Equal(32, results.DeminifiedStackFrameResults[5].StackFrame.SourcePosition.Line);
	}
